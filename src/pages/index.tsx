    ...
    <header aria-label="Site Header" className="bg-white">
      <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
        <Link href="/" className="block text-red-600">
          <span className="">Story Analytics</span>
        </Link>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock the full potential of your Shopify store with Story Analytics - the ultimate AI-powered data insights tool."
        />
